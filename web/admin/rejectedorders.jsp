...
<html>
    ...
    <head>
        <title>Rejected Orders - Uva CareCare</title>
        <meta charset="UTF-8">
...
<div id="content" class="container">
	<div class="row">
		<div class="box">
                    <div class="col-lg-12">
                    <h3 class="text-success text-uppercase text-center" style="font-weight: 600">Rejected Orders</h3>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <%
                                            String getNewAppoSql = "SELECT * FROM appoinment WHERE Status='Rejected'";
